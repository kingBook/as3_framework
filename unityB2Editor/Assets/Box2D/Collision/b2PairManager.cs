...
//public:
	public b2PairManager(){
		m_pairs = new List<b2Pair>();
		m_pairBuffer = new List<object>();
		m_pairCount = 0;
		m_pairBufferCount = 0;
		m_freePair = null;
	}
	...
	public void Initialize(b2BroadPhase broadPhase){
...
//public:
	...
	public List<b2Pair> m_pairs;
	private b2Pair m_freePair;
	public int m_pairCount;
	
	private  List<object> m_pairBuffer;
