...
{
	public b2Manifold(){
			m_points = new List<b2ManifoldPoint>(b2Settings.b2_maxManifoldPoints);
		for (int i = 0; i < b2Settings.b2_maxManifoldPoints; i++){
			m_points.Add(new b2ManifoldPoint());
		}
	...
	public List<b2ManifoldPoint> m_points;	
	/** Not used for Type e_points*/	
	public b2Vec2 m_localPlaneNormal;	
	/** Usage depends on manifold type */	
	public b2Vec2 m_localPoint;	
	public int m_type;
	/** The number of manifold points */	
	public int m_pointCount = 0;
	
	//enum Type
	public const int e_circles = 0x0001;
	public const int e_faceA = 0x0002;
	public const int e_faceB = 0x0004;
}
