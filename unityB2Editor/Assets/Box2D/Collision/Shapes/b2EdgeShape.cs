...
public class b2EdgeShape : b2Shape
{
	...
	*/
			...
			b2Vec2 c)
	{
		...
		float d1 = b2Math.Dot(normal, v1) - offset;
		float d2 = b2Math.Dot(normal, v2) - offset;
		if (d1 > 0)
		{
			if (d2 > 0)
			{
		...
		return 0.5f * ( (v1.x - v0.x) * (v2.y - v0.y) - (v1.y - v0.y) * (v2.x - v0.x) );
	}
	...
	*/
	public b2Vec2 GetDirectionVector()
	{
		return m_direction;
	}
	...
	*/
	public b2Vec2 GetCorner1Vector()
	{
		return m_cornerDir1;
	}
	...
	*/
	public b2Vec2 GetCorner2Vector()
	{
		return m_cornerDir2;
	}
	...
	*/
	public b2EdgeShape GetNextEdge()
	{
		return m_nextEdge;
	}
	...
	*/
	public b2EdgeShape GetPrevEdge()
	{
		return m_prevEdge;
	}

	private b2Vec2 s_supportVec = new b2Vec2();
	/**
	...
	* @private
	*/
	public b2EdgeShape(b2Vec2 v1, b2Vec2 v2):base(){
		m_type = e_edgeShape;
	...
	*/
	...
	public b2Vec2 m_coreV1 = new b2Vec2();
	public b2Vec2 m_coreV2 = new b2Vec2();
	
	public float m_length;
	
	public b2Vec2 m_normal = new b2Vec2();
	
	public b2Vec2 m_direction = new b2Vec2();
	
	public b2Vec2 m_cornerDir1 = new b2Vec2();
	
	public b2Vec2 m_cornerDir2 = new b2Vec2();
	
	public bool m_cornerConvex1;
	public bool m_cornerConvex2;
	
	public b2EdgeShape m_nextEdge;
	public b2EdgeShape m_prevEdge;
