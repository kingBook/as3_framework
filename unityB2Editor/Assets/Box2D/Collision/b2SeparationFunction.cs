...
{
	//enum Type
	public const int e_points = 0x01;
	public const int e_faceA = 0x02;
	public const int e_faceB = 0x04;
	...
	public float Evaluate(b2Transform transformA, b2Transform transformB)
	{
		b2Vec2 axisA;
		b2Vec2 axisB;
		b2Vec2 localPointA;
