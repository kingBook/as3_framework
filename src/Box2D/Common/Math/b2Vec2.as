...
public class b2Vec2
{
	...
	// add by kingBook 2017/6/20
	public function SetV3(v:b2Vec3):void{x=v.x; y=v.y;}
	...
	static public function MakeFromAngle(angle:Number,length:Number,isOnce:Boolean=false):b2Vec2{
		var v:b2Vec2=isOnce?_onceV:new b2Vec2(0,0);
		v.x=Math.cos(angle)*length;
		v.y=Math.sin(angle)*length;
		return v;
	}
	static public function Distance(v1:b2Vec2,v2:b2Vec2):Number{
	...
	public function toString(ptm_ratio:Number=1):String{
