...
public class b2PulleyJoint extends b2Joint
{
	...
	public function GetGroundAnchorA() :b2Vec2
	{
		...
		var a:b2Vec2 = m_ground.GetPosition().Copy();
	...
	public function GetLength1() :Number
	{
		...
		var sX:Number = m_ground.GetPosition().x + m_groundAnchor1.x;
		var sY:Number = m_ground.GetPosition().y + m_groundAnchor1.y;
		//b2Vec2 d = p - s;
	...
	// static
	static public const b2_minPulleyLength:Number = 0;
};
