...
public class b2RopeJointDef extends b2JointDef
{
	...
	*/
	public function Initialize(bA:b2Body, bB:b2Body,anchorA:b2Vec2, anchorB:b2Vec2,maxLength:Number) : void
	{
		...
		localAnchorA.x=Number(localAnchorA.x.toFixed(2));
		localAnchorA.y=Number(localAnchorA.y.toFixed(2));
		localAnchorB.x=Number(localAnchorB.x.toFixed(2));
		localAnchorB.y=Number(localAnchorB.y.toFixed(2));
