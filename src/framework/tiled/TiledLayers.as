package framework.tiled {
	...
	public class TiledLayers {
		...
		/**根据名称返回层列表*/
		public function getByNameLayers(name:String):Vector.<TiledLayer>{
			return layers.filter(function(el:TiledLayer, i:int, arr:Vector.<TiledLayer>):Boolean { return el.name==name; });
		}
