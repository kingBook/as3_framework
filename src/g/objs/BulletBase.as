package g.objs{
    ...
    public class BulletBase extends MovableObject{
        protected var _obsTags:Vector.<String>=new Vector.<String>();
        protected var _shooterBody:b2Body;
        public static function create(x:Number,y:Number,angle:Number,speed:Number,shooterBody:b2Body=null,viewDefName:String=null):void{
            ...
            info.angle=angle;
            info.speed=speed;
            game.createGameObj(new BulletBase(),info);
        }
